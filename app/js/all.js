...
document.addEventListener("DOMContentLoaded", function () {
  ...
  timers.forEach(function (timer) {
    var startTime = timer.classList.contains("timer_big") ? 5 * 3600 + 45 * 60 + 47 // Таймер big: 05:45:47
    ...
    function updateTimer() {
      ...
      timer.querySelector("span").textContent = String(hours).padStart(2, "0") + ":" + String(minutes).padStart(2, "0") + ":" + String(seconds).padStart(2, "0");
    }
